...
describe.only('Things Endpoints', function() {
  ...
  describe(`GET /api/things/:thing_id`, () => {
    context(`Given no things`, () => {
      ...
      it(`responds with 404`, () => {
        ...
        return supertest(app)
          ...
          .set('Authorization', helpers.makeBase64Thing(testUsers[0]))
    ...
    context(`Given an XSS attack thing`, () => {
      const testUser = helpers.makeUsersArray()[1]
      testUser.password = bcrypt.hashSync(testUser.password, 1)
      const {
        maliciousThing,
        expectedThing,
      } = helpers.makeMaliciousThing(testUser)
      ...
      it.skip('removes XSS attack content', () => {
        ...
        return supertest(app)
          ...
          .set('Authorization', helpers.makeBase64Thing(testUser))
          .expect(200)
          .expect(res => {
